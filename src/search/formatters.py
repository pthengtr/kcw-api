...
CODE1_DISPLAY_MAP = {
    ...
    "D": {"name": "บูช", "size_labels": ["ใน", "นอก", "หนา"]},
    ...
    "I": {"name": "ลูกปืนกลับ", "size_labels": ["ใน", "นอก", "หนา"]},
    "K": {"name": "ขาเกล้ง", "size_labels": ["ขา(นิ้ว)", "ฟัน", "ขนาดรูเฟือง"]},
    ...
    "Q": {"name": "ลูกหมาก", "size_labels": ["เดเปอร์", "แกนโต"]},
    "R": {"name": "ลูกยางต่างๆ", "size_labels": ["ใน", "นอก", "หนา"]},
}
