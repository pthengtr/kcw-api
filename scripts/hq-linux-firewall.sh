#!/usr/bin/env bash
# Harden inbound on HQ Ubuntu: SSH, Tailscale, NoMachine, Samba 445 LAN, KCW LAN services only.
...
ufw allow from 192.168.1.0/24 to any port 445 proto tcp comment 'Samba SMB LAN'
