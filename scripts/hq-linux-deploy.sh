...
systemctl --user restart kcw-tiger-pay.service kcw-stock-check.service
...
systemctl --user --no-pager --full status kcw-tiger-pay.service kcw-stock-check.service kcw-worker.service | tail -n 40
