#!/usr/bin/env python3
"""Install ICMAS_QTYOH2_AUDIT + trigger on KSS PARTS9 via SMB copy + WinRM sqlcmd -E."""
...
SQL_PATH = REPO / "scripts" / "sql" / "icmas_qtyoh2_audit.sql"
...
REMOTE_REL = r"TEMP\icmas_qtyoh2_audit.sql"
LOCAL_SQL = r"D:\KAcc9\TEMP\icmas_qtyoh2_audit.sql"
...
def main() -> None:
    ...
    if "trg_ICMAS_qtyoh2_audit" not in SQL_PATH.read_text(encoding="utf-8"):
...
sqlcmd -S localhost -d PARTS9 -E -W -Q "SELECT name, create_date, modify_date FROM sys.triggers WHERE name = 'trg_ICMAS_qtyoh2_audit'; SELECT OBJECT_ID(N'dbo.ICMAS_QTYOH2_AUDIT') AS audit_table_id;"
"""
    ...
    print("OK: ICMAS_QTYOH2_AUDIT + trg_ICMAS_qtyoh2_audit installed on KSS PARTS9")
